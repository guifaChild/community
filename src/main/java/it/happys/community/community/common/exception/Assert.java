package it.happys.community.community.common.exception;


import it.happys.community.community.common.result.ResponseEnum;
...
public class Assert {
    ...
    public static void notNull(Object obj, ResponseEnum responseEnum){
        if(obj == null){
            ...
            throw new it.happys.community.community.common.exception.BusinessException(responseEnum);
        }
    }
